...
public class ArrayEx2 {
	...
	public void method2() {
		...
		System.arraycopy(copyArr, 0, copyArr2, 0,arr.length);
		
		// 원본, 복사본1 ,복사본2의 0번 인덱스 값을 변경
		arr[0] = 11111;
		copyArr[0] = 22222;
		copyArr2[0] = 33333;
		System.out.println("arr :" + Arrays.toString(arr));
	...
	public void method5() {
		...
		// for문으로 모든 요소 출력하기 1 (향상된 for문)
		
		for (int[] row : arr) { // 행을 하나씩 순차적으로 접근
			for(int col : row) { // 각 행의 열을 하나씩으로 순차적으로 접근
