...
public class ArrayEx1 {
	 ...
	 * 
	 * - 변수 호출 시 값을 반환하지 않음 -> 저장된 주소로 찾아가 해당 위치의 배열/객체를 참조
	 * 
...
//		arr[2] = 3.14; // int 배열 요소에  double 대입 불가
	...
	//  debug(디버그) : 프로그램 수행이 정상적으로 이루어지지 않은 경우
	// 		   			원인을 파악하기 위해 추적하는 것
	//					+ 해결까지 이루어짐
	...
	public void method99() {
		// 게임이 작성되어 있는 배열 생성 
		String [] subjects = { "LOL","SA","MAPLE","DNF","DBD"};
		
		int game = (int)(Math.random()*subjects.length);
		System.out.printf("당신이 할 게임은 %s 입니다",subjects[game]);
	}
