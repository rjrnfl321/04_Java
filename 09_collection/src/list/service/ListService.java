 ...
 * [특징]
 * 1) 크기 제한 X
 * 2) 추가,수정,삭제,검색 정렬 등 다양한 기능이 제공
 * 3) 객체만 저장 가능 (정확하게는 객체 참조 주소만 저장 가능)
 * 
 * 
 * [List]
...
public class ListService {
	...
	public void test1() {
		...
		List list = new ArrayList(3); // 기본 10칸 짜리 생성
	...
	public void test2() {
		...
		System.out.println("보쌈 : " + menuList.contains("보쌈")); // false
		System.out.println("냉면 : " + menuList.contains("냉면")); // true
		...
		System.out.println("계란말이 : " + menuList.indexOf("계란말이"));
		System.out.println("감자튀김 : " + menuList.indexOf("감자튀김"));
