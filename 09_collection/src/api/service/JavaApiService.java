...
public class JavaApiService {
	 ...
	 * [ String 객체를 생성하는 방법 ]
	 * 
	 * 1) Stirng s1 = "Hello";	// 리터럴 표기법을 이용한 방법
	 * 		-> Heap 영역 내부에 Constant(상수) Pool에 String 객체 생성
	 * 2) Stirng s2 = new String("Hello"); // new 연산자 이용한 방법
	...
	public void test1() { 
		...
		// TestDto 객체의 주소를 주소를 이용해서 만든 해시코드 확인
