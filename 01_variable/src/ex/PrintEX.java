...
public class PrintEX {
	public static void main(String[] args) {
		 ...
		 *  String name = "홍길동";
		 *  
		 *  System.out.prinf("나는 %s 입니다", name);
		 * 
		 *   
		 *  %d : 정수 (byte, short, int)
		 *  %c : 문자 (char)
		...
		// 홍길동은 25세 남성으로 키는 212.5cm이고, 자바 공부 여부 : true
		...
		System.out.println(name +"은 " 
						  ...
						  + javaStudy); 
		// printf() 버전
		System.out.printf("%s은 %d세 %c성으로 키는 %fcm이고, 자바 공부 여부 : $b",
		...
		// 문자열 6칸 오른쪽 정렬 : %-6s
		System.out.println(); 
		System.out.printf("%-6s/%f", name, height ); // 홍길동 ㅁㅁㅁ/ 212.500000
