package ex;import javax.xml.xpath.XPathEvaluationResult.XPathResultType;
...
public class VariableEx3 {
	public static void main(String[] args) {
		...
		int num1 = 290;
		byte result1 = (byte)num1; // byte 강제 형변
		...
		System.out.println("원 번호 : " + (int)'원'); // 50896
		
		System.out.println("ㄱ 번호 : " + (int)'ㄱ');
		...
		System.out.println("max + 1 :" + (max+1)); // -2147483647
