...
public class TryCatchService {
	...
	public void test1() {
		...
		// - 스캐너 입력 시
		// next자료형()으로 읽어오는 값과
		// 입력된 값의 자료형이 일치하지 않을 떄

		System.out.print("정수 입력 : ");
		int input = sc.nextInt();
		// 콘솔 입력시 문자열 입력/실수/값의 범위 초과 입력
	...
	public void test2() {
		...
		try {
			...
			System.out.println("정수만 입력해줘 ㅜㅜ");
	 ...
	 * 예외처리 + 다형성 (업 캐스팅)
	 * 
	 * RuntimeException : - 실행 중 발생하는 모든 예외의 최상위 부모 예외 - Unchecked Exception -> 예외
	 * 처리 구문을 꼭 작성할 필요는 없는 예외
	 */
	public void test4() {
		...
		// InputMistmatchException에 빨간줄(컴파일 에러)이
		// 발생하는 이유 :
...
//		}
	 ...
	 * 
	 * - throw new 예외클래스(); -> 생성된 예외 객체를 던짐 == 예외 강제 발생
	 */
	public void test5() {
