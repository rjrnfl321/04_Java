...
public class OperatorEx {
	 ...
	 * 
	 * [true인 경우] 첫 번째 입력 : 20 두 번째 입력 : 5 20은 5의 배수가 맞는가? true
	 * 
	 * [false인 경우] 첫 번째 입력 : 9 두 번째 입력 : 4 9은 4의 배수가 맞는가? false
	 */
	public void method3() {
		Scanner sc = new Scanner(System.in);
		...
		boolean isTrue = num0 % num1 == 0;
		System.out.printf("%d는 %d의 배수인가? %b", num0, num1, isTrue);
	}

	/**
	 * 생성된 난수가 1 이상 10 이하 짝수가 맞는지 확인 (난수 범위 1 ~ 20)
	 */
	public void method4() {
	...
	public void method5() {
		...
		boolean result1 = (input1 % 2 == 0) || (input1 > 10);
